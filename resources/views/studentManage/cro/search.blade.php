@extends('layouts.app', ['title' => 'Search Result Student'])
                    ...
                    <div>
                        <form action="{{ route('student_search_cro') }}" method="GET">
                            <div class="input-group">
                                <input type="text" value="{{ request()->get('registration_number') }}" class="form-control"
                                    name="registration_number" placeholder="Registration Number">
                                <input type="text" value="{{ request()->get('mobile_number') }}" class="form-control" name="mobile_number" placeholder="Mobile Number">
                                <input type="text" value="{{ request()->get('student_name') }}" class="form-control" name="student_name" placeholder="Student Name">
