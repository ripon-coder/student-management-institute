...
@section('content')
    <div class="app-card app-card-settings shadow-sm p-4">
        ...
        <a class=" btn-sm app-btn bg-info text-white  float-end"
        href="{{route('studentExport')}}">
                            ...
                            <tbody class="duepayment">
                                @foreach ($duepayment as $item)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary" target="_blank"
                                        ...
                                        <td class="cell">
                                            <a class="text-white btn-sm @if (isset($item->note)) app-btn-primary @else bg-secondary @endif"
                                                data-bs-toggle="collapse" data-bs-target="#collapsedue{{ $item->id }}"
                                    ...
                                    <tr>
                                        <td colspan="12" class="cell p-0 bg-white">
                                            <div id="collapsedue{{ $item->id }}" class="accordian-body collapse">
                                                <div class="p-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell">
                                            ...
                                            <a class="text-white btn-sm @if (isset($item->note)) app-btn-primary @else bg-secondary @endif"
                                                ...
                                                aria-expanded="false" aria-controls="collapsedue">Reminder</a>
                                        </td>
                                        <td class="cell">
                                            <a class="text-white btn-sm app-btn-primary"
                                                href="{{ route('studenteditadmin', $item->id) }}">Edit</a>
