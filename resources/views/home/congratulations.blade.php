...
<body>
    <div class="contain">
        <div class="congrats">
            <h1>অভি<span>নন্দন</span> !</h1>
            <div class="done">
                <svg version="1.1" id="tick" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 37 37"
                    style="enable-background:new 0 0 37 37;" xml:space="preserve">
                    <path class="circ path"
                        style="fill:#0e8522;stroke:#080808;stroke-width:3;stroke-linejoin:round;stroke-miterlimit:10;"
                        d="
        ...
        11.6,20 15.9,24.2 26.4,13.8 " />
            ...
            <div class="text">
                <p>
                    ...
                    @endif, আপনি সফলভাবে স্কলারশিপের জন্য ২০ জনের মধ্যে সিলেক্টেড হয়েছেন ।
                    <br><br>
                    নামঃ @if (Session::get('student'))
                        {{ Session::get('student')->name }}
                    @endif
                    <br>
                    রেজিষ্ট্রেশন নাম্বারঃ @if (Session::get('student'))
                        {{ Session::get('student')->id }}
                    @endif
                    <br>
                    কোর্সঃ @if (Session::get('student'))
                        {{ Session::get('student')->course->title }}
                    @endif
                    <br>
