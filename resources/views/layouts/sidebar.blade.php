        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                @role('Admin')
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="submenu-toggle nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
                            <span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link {{ request()->is('dashboard/overview*') ? 'active' : '' }}" href="{{route('overview')}}">Overview</a></li>
                                <li class="submenu-item"><a class="submenu-link {{ request()->is('dashboard/payment-activities*') ? 'active' : '' }}" href="{{route('payment.index')}}">Payment Activities</a></li>
                                <li class="submenu-item"><a class="submenu-link {{ request()->is('dashboard/expense*') ? 'active' : '' }}" href="{{route('expense.index')}}">Expense Manage</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
